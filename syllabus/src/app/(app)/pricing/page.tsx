...
export default function PricingPage() {
  ...
  async function choose(tierId: TierId) {
    ...
    setBusyTier(tierId);
    try {
      const checkout = await apiPost("/api/billing/checkout", { tier: tierId });
  ...
  return (
    <div className="mx-auto max-w-5xl">
      <div className="text-center">
        ...
        <p className="mt-2 font-medium text-ink-light">Upgrade anytime. Secure checkout powered by Dodo Payments.</p>
      </div>
